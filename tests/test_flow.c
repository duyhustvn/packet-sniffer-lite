...
void test_flow_insert_and_lookup(void) {
  ...
  FlowTestCase cases[] = {
      ...
      },
      {
          ...
          .src_port = 4321,
          .dst_port = 443,
          .data = {0x16, 0x03, 0x03, 0x00, 0x05, 0x05, 0x06, 0x07, 0x08, 0x09},
          .data_len = 10,
          .seq = 3000,
          .expected_buffer = {0x16, 0x03, 0x03, 0x00, 0x05, 0x05, 0x06, 0x07, 0x08, 0x09},
          .expected_len = 10,
      ...
      },
      {
          ...
          .src_port = 8888,
          .dst_port = 443,
          .data = {0x16, 0x03, 0x03, 0x00, 0x05},
          .data_len = 5,
          .seq = 4000,
          .expected_buffer = {0x16, 0x03, 0x03, 0x00, 0x05},
          .expected_len = 5,
